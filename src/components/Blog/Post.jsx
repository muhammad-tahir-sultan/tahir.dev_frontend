            ...
            <div className="container mx-auto flex flex-wrap py-6">
                    ...
                    <div className="w-full flex flex-col text-center md:text-left md:flex-row shadow mt-10 mb-10 p-6">
                        ...
                        <div className="flex-1 flex flex-col justify-center md:justify-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start text-2xl no-underline pt-4">
                                <a className="" href="https://facebook.com/Tahir.dev">
                                    <i className="fab fa-facebook"></i>
                                </a>
                                <a className="pl-4" href="https://instagram.com/Tahir.dev">
                                    <i className="fab fa-instagram"></i>
                                </a>

                                <a className="pl-4" href="https://linkedin.in/Tahir.dev">
                ...
                <aside className="w-full md:w-1/3 flex flex-col items-center px-3">
                    ...
                    <div className="w-full  shadow flex flex-col my-4 p-6">
                        ...
                        <a href="https://instagram.com/Tahir.dev" className="w-full font-bold text-sm uppercase rounded flex items-center justify-center px-2 py-3 mt-6">
                            <i className="fab fa-instagram mr-2"></i> Follow @Tahir.dev
                        </a>
                    </div>
                </aside>
