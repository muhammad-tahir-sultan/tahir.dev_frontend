...
const Education = () => {
    ...
    const education = [
        ...
        },
        {
            ...
            location: "Remote",
            period: "2021 - Present",
            description: "Continuously expanding my skills through self-directed learning and online courses, focusing on modern web technologies and development practices.",
            courses: [
                "React.js Mastery",
                "Node.js & Express",
                "MongoDB Database",
                    ...
                    {education.map((item, index) => (
                        ...
                        >
                            <div className="flex flex-col md:flex-row md:items-center mb-4">
                                ...
                                <div className={`md:ml-auto mt-2 md:mt-0 px-4 py-2 rounded-full text-sm font-medium ${darkMode ? "bg-blue-900/30 text-blue-400" : "bg-blue-100 text-blue-600"
                                    }`}>
                                    {item.period}
                                </div>
                            </div>
                            ...
                            {index === 0 && (
                                <div className={`mt-6 px-4 py-3 rounded-lg ${darkMode ? "bg-gray-800/60" : "bg-blue-50"
                                    }`}>
                                    <div className="flex items-start">
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mt-0.5 mr-2 ${darkMode ? "text-blue-400" : "text-blue-500"
                            ...
                            {index === 1 && (
                                <div className={`mt-6 px-4 py-3 rounded-lg ${darkMode ? "bg-gray-800/60" : "bg-blue-50"
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <p className="text-sm">
                                            <span className="font-medium">Achievement: </span>
                                            Completed over 15 certification courses and built several personal projects applying these technologies.
                                        </p>
                                    </div>
                                </div>
                            )}
