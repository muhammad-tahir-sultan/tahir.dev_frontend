                        ...
                        >
                            <Dialog.Panel className={`relative transform overflow-hidden rounded-lg ${darkMode ? "bg-gray-800" : "bg-white"} text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg`}>
                                ...
                                <div className={`${darkMode ? "bg-gray-700" : "bg-gray-50"} px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6`}>
                                    <button
                                        type="button"
                                        className="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 sm:ml-3 sm:w-auto transition duration-150 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    ...
                                    <button
                                        type="button"
                                        className={`mt-3 inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset sm:mt-0 sm:w-auto focus:outline-none focus:ring-2 ${
                                            darkMode 
                                                ? "bg-gray-600 text-gray-200 ring-gray-500 hover:bg-gray-500 focus:ring-gray-400" 
                                                : "bg-white text-gray-900 ring-gray-300 hover:bg-gray-50 focus:ring-gray-500"
                                        }`}
                                        onClick={handleClose}
                                        ref={cancelButtonRef}
                                    >
