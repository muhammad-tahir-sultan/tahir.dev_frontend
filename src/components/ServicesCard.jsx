...
const ServicesCard = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            description: "Building online stores with secure checkout, product management, and seamless user experience to boost your sales.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            description: "Creating fast, reliable, and engaging web applications that work offline and provide app-like experiences.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            id: 9,
            title: "UI/UX Design",
            description: "Designing intuitive, user-friendly interfaces that enhance user satisfaction and improve conversion rates.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
