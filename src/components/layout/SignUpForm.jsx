...
const SignUpForm = () => {
    ...
    return (
        <div className={`flex min-h-full flex-col justify-center px-6 py-24 lg:px-8 ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="flex justify-center">
                    <img className="h-28 w-auto rounded-full shadow-lg transform hover:scale-105 transition-transform duration-300" 
                        src="/logo.png" alt="Tahir.dev Programmer" />
                </div>
                <h2 className={`mt-6 text-center text-3xl font-extrabold ${darkMode ? "text-white" : "text-gray-900"}`}>
                    Create an Account
                </h2>
                <p className={`mt-2 text-center text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                    Signup to Add Review and get <span className='font-bold text-green-400'>10% off</span> on your next purchase
                </p>
            </div>
