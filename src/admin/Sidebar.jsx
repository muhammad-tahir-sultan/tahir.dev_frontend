      ...
      <div className="px-6 py-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Link to="/" className="flex items-center justify-center h-16 rounded-lg text-white">
              <img src="/logo.png" alt="logo" className='h-16' />
            </Link>
            <h2 className="text-xl font-bold tracking-tight">Tahir<span className="text-blue-500"> .dev</span></h2> 
          </div>
        </div>
      </div>
